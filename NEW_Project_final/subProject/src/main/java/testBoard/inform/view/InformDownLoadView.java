...
public class InformDownLoadView extends AbstractView {

	
	private InformDAO informDao;

	public InformDownLoadView() {

	}

	
	public InformDownLoadView(InformDAO informDao) {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		String upload = informDao.getFile(notice_code);
