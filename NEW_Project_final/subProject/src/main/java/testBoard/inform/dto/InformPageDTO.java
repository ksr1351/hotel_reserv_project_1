...
public class InformPageDTO {
	...
	public InformPageDTO() {

	}

	public InformPageDTO(int currentPage, int totalCount) {
	...
	public InformPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
